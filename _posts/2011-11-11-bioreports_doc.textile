...
You can add a link to the image by adding a @:@ to the end of the image url and then providing the link. For example, an image that links to itself can be created using:

{% highlight html %}
!(small)data/demo_data/bad_reads.png:data/demo_data/bad_reads.png!
{% endhighlight %}
